...
export default function AdminLogin({ onBack, onConfirm, onLogin }: AdminLoginProps) {
		...
		<div className="bio-login-shell bio-auth-shell">
			...
			<div className="bio-auth-panel">
				<div className="bio-auth-header">
					...
					<div>
						<p className="bio-auth-step">Organization Admin</p>
						<h2 className="bio-auth-title">Admin Login</h2>
					</div>
				</div>

				<p className="bio-auth-subtitle">
					Masuk sebagai admin untuk mengelola organisasi, tim, dan akses anggota laboratorium.
				</p>
